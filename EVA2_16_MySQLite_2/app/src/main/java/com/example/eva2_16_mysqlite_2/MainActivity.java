...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            sqlDB.execSQL("insert into mitabla(nombre, apellido) values('RUBEN','DERNANDEZ')");
            sqlDB.execSQL("insert into mitabla(nombre, apellido) values('MIGUEL','QUINTANA')");
            ...
            sqlDB.execSQL("insert into mitabla(nombre, apellido) values('PEDRO','INFANTE')");
            sqlDB.execSQL("insert into mitabla(nombre, apellido) values('MARIA','FELIX')");
